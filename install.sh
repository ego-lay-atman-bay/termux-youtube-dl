...
curl -L https://raw.githubusercontent.com/ego-lay-atman-bay/termux-youtube-dl/v2.0.1/.ytdl.conf >"${YOUTUBEDL_CONFIG_FOLDER}/config"
curl -L https://raw.githubusercontent.com/ego-lay-atman-bay/termux-youtube-dl/v2.0.1/sponsorblock.conf >"${YOUTUBEDL_CONFIG_FOLDER}/sponsorblock.conf"
curl -L https://raw.githubusercontent.com/ego-lay-atman-bay/termux-youtube-dl/v2.0.1/share2youtubedl.sh >"${TERMUXURLOPENER_CONFIG_FOLDER}/termux-url-opener"
